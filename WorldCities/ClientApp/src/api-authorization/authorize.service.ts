...
export class AuthorizeService {
  ...
  public get userManager(): UserManager {
    return this._userManager as any as UserManager;
  }
  public set userManager(value: UserManager) {
    this._userManager = value;
  }
  private userSubject: BehaviorSubject<IUser | null> = new BehaviorSubject<IUser | null>(
    null
  );
  ...
  private getUserFromStorage(): Observable<IUser> {
    return from(this.ensureUserManagerInitialized()).pipe(
      ...
      map((u) => u?.profile ?? (null as any as IUser))
    );
  }
}
